    ...
    days: [
      {
        day: "Template 1",
        meals: [
          { meal: "Breakfast", food: "2 whole eggs + 2 egg whites scrambled, 1 slice whole-grain toast, 1/2 avocado (veg swap: same, eggs are veg)", kcal: 360, protein: 26, fiber: 6 },
          { meal: "Mid-morning snack", food: "1 cup plain non-fat Greek yogurt + 1/2 cup berries", kcal: 150, protein: 16, fiber: 3 },
          { meal: "Lunch", food: "150g grilled chicken breast (veg swap: 150g tofu or paneer) + 1/2 cup cooked quinoa + roasted broccoli & bell peppers, olive oil drizzle", kcal: 460, protein: 38, fiber: 8 },
          { meal: "Afternoon snack", food: "Protein shake (1 scoop whey or plant protein + water/almond milk)", kcal: 130, protein: 24, fiber: 1 },
          { meal: "Dinner", food: "150g baked salmon (veg swap: 150g tempeh) + roasted sweet potato + side salad with chickpeas", kcal: 480, protein: 32, fiber: 9 },
        ],
      },
      {
        day: "Template 2",
        meals: [
          { meal: "Breakfast", food: "Overnight oats: 1/2 cup oats, 1 scoop protein powder, 1 tbsp chia seeds, almond milk, banana", kcal: 380, protein: 30, fiber: 8 },
          { meal: "Mid-morning snack", food: "1 boiled egg + small apple", kcal: 150, protein: 8, fiber: 4 },
          { meal: "Lunch", food: "Turkey & black bean bowl (veg swap: black beans + tofu): 120g protein + 1/2 cup black beans + brown rice + salsa", kcal: 460, protein: 34, fiber: 10 },
          { meal: "Afternoon snack", food: "Cottage cheese 3/4 cup + cucumber/carrot sticks", kcal: 140, protein: 18, fiber: 2 },
          { meal: "Dinner", food: "Stir-fried shrimp (veg swap: edamame) + mixed vegetables + 1/2 cup jasmine rice", kcal: 470, protein: 30, fiber: 6 },
        ],
      },
      {
        day: "Template 3",
        meals: [
          { meal: "Breakfast", food: "Greek yogurt parfait: 1 cup Greek yogurt, granola, mixed berries, 1 tbsp nut butter", kcal: 390, protein: 28, fiber: 6 },
          { meal: "Mid-morning snack", food: "Protein bar (~20g protein, look for one with 3g+ fiber)", kcal: 180, protein: 20, fiber: 4 },
          { meal: "Lunch", food: "Lentil & veggie soup (1.5 cups) + 100g grilled chicken or paneer on the side", kcal: 440, protein: 32, fiber: 11 },
          { meal: "Afternoon snack", food: "Hummus (3 tbsp) + bell pepper & carrot sticks", kcal: 140, protein: 6, fiber: 4 },
          { meal: "Dinner", food: "Ground turkey (veg swap: crumbled tempeh) taco bowl: lettuce, black beans, salsa, small corn tortilla, light cheese", kcal: 470, protein: 30, fiber: 7 },
        ],
      },
      {
        day: "Template 4",
        meals: [
          { meal: "Breakfast", food: "Veggie egg muffins (3, made with whole eggs + spinach + feta) + 1 slice whole-grain toast", kcal: 360, protein: 27, fiber: 4 },
          { meal: "Mid-morning snack", food: "1 cup skyr/Greek yogurt + handful walnuts", kcal: 170, protein: 18, fiber: 2 },
          { meal: "Lunch", food: "Grain bowl: 1/2 cup farro or quinoa, roasted chickpeas, roasted veg, 100g grilled chicken or tofu, tahini dressing", kcal: 470, protein: 30, fiber: 10 },
          { meal: "Afternoon snack", food: "Protein shake + 1 small pear", kcal: 150, protein: 24, fiber: 4 },
          { meal: "Dinner", food: "Baked cod (veg swap: baked tofu) + roasted brussels sprouts + 1/2 cup wild rice", kcal: 440, protein: 28, fiber: 8 },
        ],
      },
    ],
  },
