  ...
  nutrition: {
    ...
    days: [
      ...
      },
      {
        ...
        meals: [
          { meal: "Breakfast", short: "Besan-paneer chilla", food: "Besan (chickpea flour) chilla with paneer bhurji, onion, tomato & spinach mixed in, mint-yogurt on the side — pan-cooked with minimal oil, not fried", kcal: 360, protein: 26, fiber: 6 },
          { meal: "Mid-morning snack", short: "Egg + apple", food: "1 boiled egg + small apple", kcal: 150, protein: 8, fiber: 4 },
          { meal: "Lunch", short: "Tandoori tikka + raita", food: "Tandoori chicken tikka (grilled, not fried — veg swap: paneer tikka) + cucumber-mint raita (low-fat yogurt) + 1/2 cup brown rice or 1 small roti", kcal: 460, protein: 38, fiber: 6 },
          { meal: "Afternoon snack", short: "Roasted chana + veg", food: "Roasted chana (chickpea) snack, 1/2 cup + cucumber sticks", kcal: 160, protein: 9, fiber: 7 },
          { meal: "Dinner", short: "Rajma + rice + raita", food: "Rajma (kidney bean curry, light oil, no cream) + 1/2 cup brown rice + side of cucumber raita", kcal: 480, protein: 24, fiber: 13 },
        ],
      },
      {
        day: "Template 3 — South Indian",
        meals: [
          { meal: "Breakfast", short: "Idli + sambar + curd", food: "2 steamed idlis + sambar (1 cup, lentil & vegetable) + small bowl plain curd (skip the fried vada/extra chutney oil)", kcal: 350, protein: 18, fiber: 7 },
          { meal: "Mid-morning snack", short: "Makhana + chaas", food: "Roasted makhana (fox nuts), small bowl + spiced buttermilk (chaas)", kcal: 150, protein: 6, fiber: 3 },
          { meal: "Lunch", short: "Grilled fish + lemon rice", food: "Grilled tilapia or king fish (veg swap: paneer) + lemon rice (1/2 cup) + cabbage poriyal (stir-fried, light oil)", kcal: 460, protein: 36, fiber: 7 },
          { meal: "Afternoon snack", short: "Greek yogurt + berries", food: "Greek yogurt + berries", kcal: 150, protein: 20, fiber: 2 },
          { meal: "Dinner", short: "Moong dal + poriyal", food: "Moong dal (yellow lentil, light tadka) + vegetable poriyal + small brown rice or 1 ragi roti", kcal: 470, protein: 26, fiber: 12 },
        ],
      },
      {
        day: "Template 4",
        meals: [
          ...
          { meal: "Dinner", short: "Tilapia + brussels + rice", food: "Baked tilapia (veg swap: baked tofu) + roasted brussels sprouts + 1/2 cup wild rice", kcal: 440, protein: 28, fiber: 8 },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        items: [
          "Eggs (1-2 dozen)",
          "Chicken breast (~1kg)",
          "Tilapia, king fish, or wild-caught salmon fillets (~450g)",
